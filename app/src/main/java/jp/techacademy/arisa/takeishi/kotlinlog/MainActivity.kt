...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var num = 1 //事前にvar num の定義が残っている場合は、エラーが出るので、varを削除
    ...
    //firstとlast、2つの引数を指定する   firstとlast、２つの引数と戻り値の型（int）を指定した関数に修正
    private fun total(first: Int, last: Int): Int{
       ...
       return sum
        ...
        val bigdog = BigDog("ヨーゼフ", 15)   //名前をヨーゼフ、年齢１５歳で、BigDogインスタンスを作る
        bigdog.say()  //ヨーゼフが吠えます（ログ出力）
